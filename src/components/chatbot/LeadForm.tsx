  ...
  return (
    <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-4 space-y-3">
      ...
      <button
        ...
        className="w-full bg-primary text-primary-foreground rounded-lg py-2.5 text-sm font-medium disabled:opacity-50 hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
      >
        {isSubmitting ? (
          <>
